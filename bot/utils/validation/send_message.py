...
async def send_message(message: Message, message_to_send: str, user_id: int):
    try:
        await asyncio.sleep(0.4)
        message_from_bot = await message.bot.send_message(chat_id=user_id, text=message_to_send)
    except ChatNotFound:
        ...
        return await send_message(message, message_to_send, user_id)
