class BotMessages:
    ...
    received_documents = 'Получил файлы\n' \
...
class BotErrors:
    ...
    error_in_timetable = 'При чтении расписания произошла ошибка.\n' \
                         'Пожалуйста, убедитесь, что в расписании:\n' \
                         '1) Ничего не пропущено, например, даты, номера пар, время пар и тд.\n' \
                         '2) Нет ли ошибок в словах, например: "отября" вместо "октября".\n' \
                         '3) Нет ли лишнего, например, символ случайно вставленный\n\n' \
                         'После этого заново отправьте файл:\n\n\n' \
                         'Если не можете найти ошибку, напишите мне: https://t.me/anondoom'
    identical_files = 'Вы отправили файлы для одного корпуса!\nНужно для двух'
    different_dates = 'У файлов разная дата!'
    old_timetable = 'Устаревшее расписание!'
